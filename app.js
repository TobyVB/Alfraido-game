...
document
  ...
  .addEventListener("click", getInputFromTextBox);
document
  .getElementById("saveScore")
  .addEventListener("click", showSaveScoreForm);
...
document
  .getElementById("exitNiceTryFail")
  .addEventListener("click", hideNiceTryFail);
...
document.getElementById("highscorePlayer").innerHTML =
...
function getInputFromTextBox() {
  ...
  window.localStorage.setItem(
    "scoresList",
    player.name + " " + player.score + "<br><hr>" + scoresList
  );
...
function changestats() {
  ...
  if (missmulti < 2) {
    ...
    document.getElementById("missmulti").innerHTML =
      "Fails: x" + (missmulti - 1);
  }

  document.getElementById("braveryStat").innerHTML =
    "Bravery: " + Math.round(person.bravery);
  document.getElementById("anticipation").innerHTML =
    "anticipation: " + person.anticipation;
...
function runAlfraido() {
  ...
  function checker() {
    ...
    if (pause === false && delay === false && startMenuActive === false) {
      // Conditions for Checker
      ...
      if (
        ...
        monsterHeight -= 0.75 * (missmulti - 1);
